...
from .medusa_choices import mc_sim_7b_63, mc_sim_7b_63_depth3
from transformers import AutoTokenizer
import os
...
class MedusaConfig(PretrainedConfig):
    ...
    Args:
        ...
        medusa_num_decoder_layers (int, optional): Number of Hydra decoder layers. Default is 0.
...
class MedusaModel(nn.Module):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if medusa_head_name_or_path == "FasterDecoding/medusa-vicuna-7b-v1.3":
            print("Overriding medusa_num_heads as:", 4)
            medusa_config.medusa_num_heads = 4
        ...
        # print(medusa_decoder_head_state_dict)
        ...
        model.medusa_rms_norm.load_state_dict(medusa_decoder_head_state_dict, strict=False)
    ...
    def forward(
        ...
        # Change this to 'torch.no_grad()' for training !!
